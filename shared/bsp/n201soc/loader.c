...
extern unsigned long __text_start, __text_lmastart, __text_lmaend, __data_start, __data_lmastart, __data_lmaend;
extern unsigned long __loader_start, __loader_lmaend, __loader_lmastart;


/* The entry function when boot, executing on ROM/FLASH. */
void __attribute__((naked, no_profile_instrument_function, section(".bootloader"))) boot_loader(void) {
	...
	src_ptr = (unsigned long *)&__loader_lmastart;
...
void __attribute__((naked, no_profile_instrument_function, section(".loader"))) loader(void) {
	...
	src_ptr = (unsigned long *)&__text_lmastart;
